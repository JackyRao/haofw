...
<body class="white-bg"  formid="tJx3UserDungeonForm">
    <form:form id="tJx3UserDungeonForm" modelAttribute="data" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		<table  class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   <tbody>
				<tr>
					...
					<td class="width-35">
						<form:input path="cd" htmlEscape="false" class="form-control"      />
				...
				<tr>
					...
					<td class="width-35">
						<form:input path="did" htmlEscape="false" class="form-control"      />
						<label class="Validform_checktip"></label>
					</td>
				</tr>
				<tr>
